...
class CheckoutFragment : Fragment() {
    ...
    fun submitOrder() {
        ...
        val orderSummary = getString(
            ...
            sharedViewModel.entree.value!!.name,
            sharedViewModel.side.value!!.name,
            sharedViewModel.accompaniment.value!!.name,
            sharedViewModel.total.value

        )
        Snackbar.make(binding.root, orderSummary, Snackbar.LENGTH_SHORT).show()
